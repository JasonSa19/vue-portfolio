<template>
  <nav
    class="absolute z-10 flex items-center justify-center w-full pt-2 transition-all duration-200 border-b-2 -top-[30rem] bg-white dark:bg-grey pb-11 border-blue"
  >
